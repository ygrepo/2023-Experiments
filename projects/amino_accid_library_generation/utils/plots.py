...
def plot_latent_space(
    ...
    if assay is not None:
        ...
        ax0.set_title("Latent Space | Training | y_true")
    if assay is not None:
        fig.colorbar(true_vals, ax=ax0, label="True Assay log2enr")
    else:
        fig.colorbar(true_vals, ax=ax0, label="True Enrichment")
    ...
    if assay is not None:
        ...
        ax1.set_title("Latent Space | Training | y_pred")
        fig.colorbar(pred_vals, ax=ax1, label="Predicted Enrichment")
